              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left text-[11px] uppercase tracking-wide text-gray-500 bg-gray-50/80 border-b border-gray-100">
                    ...
                    <th className="px-3 py-2.5 font-semibold">Answer</th>
                    <th className="px-3 py-2.5 font-semibold">Pts</th>
                ...
                <tbody>
                  {detail.items.map((it: any) => (
                    ...
                    >
                      <td className="px-3 py-2.5 font-semibold">{it.position}</td>
                      <td className="px-3 py-2.5 font-mono text-xs">
                        {it.standard || (
                          <span className="text-gray-400">no standard</span>
                        )}
                      </td>
                      <td className="px-3 py-2.5 font-semibold text-avocado-dark">
                        {it.correct_response}
                      </td>
                      <td className="px-3 py-2.5 tabular-nums">{it.points}</td>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left text-[11px] uppercase tracking-wide text-gray-500 bg-gray-50/80 border-b border-gray-100">
                ...
                <th className="px-3 py-2.5 font-semibold">Average</th>
                <th className="px-3 py-2.5 font-semibold">DI target (evidence-backed)</th>
                <th className="px-3 py-2.5 font-semibold">Most-missed Qs</th>
              </tr>
            </thead>
            <tbody>
              {a.classes.map((c: any) => (
                    ...
                    {c.needs_di ? (
                      <div className="space-y-1.5">
                        ...
                        <div className="flex flex-wrap gap-1">
                          ...
                          <span className="text-[11px] font-semibold rounded-full bg-green-50 text-green-700 border border-green-100 px-2 py-0.5">
                            🟢 {c.green_on_target}
                          </span>
                        </div>
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-xs font-semibold text-white bg-avocado hover:bg-avocado-dark rounded-lg px-2.5 py-1"
                        >
                          Build DI for this class →
                        </a>
                      </div>
                    ) : (
                      <div className="space-y-1.5">
                        <span className="inline-flex items-center gap-1 text-[11px] font-semibold rounded-full bg-green-50 text-green-700 border border-green-100 px-2 py-0.5">
                          ✓ All Green
                        </span>
                        <a
                          href={`/di-focus?grade=${f.grade}&standard=${encodeURIComponent(
                          ...
                          className="flex w-fit items-center gap-1 text-xs font-semibold text-white bg-teal-700 hover:bg-teal-800 rounded-lg px-2.5 py-1"
                        >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left text-[11px] uppercase tracking-wide text-gray-500 bg-gray-50/80 border-b border-gray-100">
                ...
                <th className="px-3 py-2.5 font-semibold">Standard</th>
                <th className="px-3 py-2.5 font-semibold">Answer</th>
                <th className="px-3 py-2.5 font-semibold">% missed</th>
                <th className="px-3 py-2.5 font-semibold">Question</th>
              </tr>
            </thead>
            <tbody>
              {a.most_missed.map((m: any) => (
                <tr key={m.position} className="border-b border-gray-50 last:border-0 align-top hover:bg-avocado/5 transition-colors">
                  <td className="px-3 py-2.5 font-semibold">{m.position}</td>
                  <td className="px-3 py-2.5 font-mono text-xs">{m.standard}</td>
                  <td className="px-3 py-2.5 font-semibold text-avocado-dark">
                    {m.correct_response}
                  </td>
                  <td className="px-3 py-2.5">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-left text-[11px] uppercase tracking-wide text-gray-500 bg-gray-50/80 border-b border-gray-100">
                ...
                <th className="px-3 py-2.5 font-semibold">Missed Qs</th>
              </tr>
            </thead>
            <tbody>
              {a.students_list.map((s: any, i: number) => (
                <tr key={i} className="border-b border-gray-50 last:border-0 hover:bg-avocado/5 transition-colors">
